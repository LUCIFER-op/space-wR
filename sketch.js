var hero, alien1, alien2, bulletH, bulletA;
var space;
...
function setup()
{
  ...
  alien1 = createSprite(500, 200, 70, 70);
...
{
  if(frameCount % 60 === 0) {
    var bullet2 = createSprite(500,200,10,40);
  ...
  function spawnBullet()
{
  ...
  if(frameCount % 60 === 0) {
    var bullet1 = createSprite(600,900,10,40);
    bullet1.addImage("bullet",bullet1i)
    //obstacle.debug = true;
    bullet1.velocityY = -10;
    bullet1.scale=0.3;
  ...
  function spawnBulletss()
  {
    if(frameCount % 60 === 0) {
      var bullet2 = createSprite(90,200,10,40);
      bullet2.addImage("bullet",bullet2i)
      //obstacle.debug = true;
      bullet2.velocityY = 50;
